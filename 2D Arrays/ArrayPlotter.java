...
public class ArrayPlotter {
   ...
   public void onColumnMajorFillButtonClick() {
      for (int c = 0; c < colorArray[c].length; c++) {
         for (int r = 0; r < colorArray.length; r++) {
            colorArray[r][c] = true;
            gui.update(colorArray);
         }
   ...
   public void onReverseColMajorFillButtonClick() {
      System.out.println(colorArray[colorArray.length - 1].length);
      for (int c = 1; c <= colorArray[colorArray.length - 1].length; c++) {
         for (int r = colorArray.length-1; r >= 0; r--) {
            colorArray[r][colorArray[colorArray.length - 1].length - c] = true;
            gui.update(colorArray);
         }
      }
   ...
   public void onMainDiagonalFillButtonClick() {
      for (int c = 0; c < colorArray.length && c < colorArray[c].length; c++) {
         colorArray[c][c] = true;
         gui.update(colorArray);
      }
   }
   ...
   public void onMainTriangleFillButtonClick() {
      for (int r = 0; r < colorArray.length && r < colorArray[r].length; r++) {
         for (int c = 0; c <= r; c++) {
            colorArray[r][c] = true;
            gui.update(colorArray);
         }
   ...
   public void onOtherDiagonalFillButtonClick() {
      for (int r = 0; r < colorArray.length && r < colorArray[r].length; r++) {
         colorArray[r][colorArray[r].length - r - 1] = true;
         gui.update(colorArray);
      }
   }
   ...
   public void onOtherTriangleFillButtonClick() {
      for (int r = 0; r < colorArray.length && r < colorArray[r].length; r++) {
         for (int c = colorArray[r].length-1; c >= colorArray[r].length-1-r; c--) {
            colorArray[r][c] = true;
            gui.update(colorArray);
         }
      }
   ...
   public void onBorderFillButtonClick() {
      ...
      if (colorArray.length > 1) {
         for (int i = 1; i < colorArray.length-1; i++) {
            colorArray[i][colorArray[i].length-1] = true;
            gui.update(colorArray);
         }
         if (colorArray[0].length == 1) {
            colorArray[colorArray.length-1][0] = true;
            gui.update(colorArray);
         } else {
